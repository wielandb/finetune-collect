...
# Convert OpenAI style message arrays into the Finetune-Collect format.
# Function call messages are merged with their results and unknown
# functions are automatically added to the FUNCTIONS list.
