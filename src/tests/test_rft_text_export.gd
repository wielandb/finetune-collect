...
func _run():
	...
	assert(parsed1.get("messages", [])[parsed1.get("messages", []).size() - 1].get("role", "") == "user")
	...
	assert(parsed2.get("messages", [])[parsed2.get("messages", []).size() - 1].get("role", "") == "user")
	...
	assert(parsed3.get("messages", [])[parsed3.get("messages", []).size() - 1].get("role", "") == "user")
