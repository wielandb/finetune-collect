...
var default_schema_validator_url = "https://example.com/validator.php"
...
func to_var():
	...
	me["jsonSchemaValidatorURL"] = $VBoxContainer/SchemaValidatorURLContainer/SchemaValidatorURLEdit.text
...
func from_var(me):
	...
	$VBoxContainer/SchemaValidatorURLContainer/SchemaValidatorURLEdit.text = me.get("jsonSchemaValidatorURL", default_schema_validator_url)
