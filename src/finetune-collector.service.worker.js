...
/** @type {string} */
const CACHE_VERSION = '1734816280|76748717256';
/** @type {string} */
const CACHE_PREFIX = 'finetune-collect-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'finetune-collector.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["finetune-collector.html","finetune-collector.js","finetune-collector.offline.html","finetune-collector.icon.png","finetune-collector.apple-touch-icon.png","finetune-collector.worker.js","finetune-collector.audio.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHABLE_FILES = ["finetune-collector.wasm","finetune-collector.pck"];
